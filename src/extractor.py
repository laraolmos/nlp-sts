...
if __name__ == '__main__':
	...
	stsextractor = STSExtractor()
	dataset = stsextractor.extract_file_examples(CORPUS_DEV)

	print(stsextractor.get_category(dataset[0]))
	print(stsextractor.get_dataset(dataset[0]))
	print(stsextractor.get_partition(dataset[0]))
	print(stsextractor.get_pearson(dataset[0]))
	print(stsextractor.get_texts(dataset[0]))
